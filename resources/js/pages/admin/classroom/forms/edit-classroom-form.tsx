...
import { EditClassroomPageProps } from '../types'; // Tipe props untuk halaman edit

const EditClassroomForm = () => {
    const { classroom, categories, teachers } =
        usePage<EditClassroomPageProps>().props;
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        teacher_id: classroom.data.teacher.id.toString(),
        thumbnail: null as File | null,
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.classrooms.update', classroom.data.id), {
            onSuccess: () => {
